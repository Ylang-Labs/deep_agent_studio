        ...
        <AnimatePresence initial={false}>
          {isOpen ? (
            <m.aside
              ...
              className="aui-files-sidebar hidden h-full w-72 shrink-0 border-l border-border/50 bg-gradient-to-b from-muted/20 via-background/40 to-muted/30 p-4 text-sm shadow-inner backdrop-blur lg:sticky lg:top-0 lg:flex lg:flex-col lg:overflow-y-auto xl:w-80"
            >
